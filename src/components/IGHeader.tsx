  ...
  return (
    <header className='sticky top-0 bg-white border-b-[1px] border-gray-300'>
      <div className='flex justify-between items-center h-[60px] px-2 box-border lg:max-w-[1024px] lg:mx-auto lg:px-0'>
        {/* Logo */}
        <img className='w-[100px] cursor-pointer' src='/images/logo.svg' alt='logo' onClick={() => go('/')} />
        <div className='flex items-center'>
          ...
          <div className='h-6 w-6 rounded-full bg-gray-900 text-white font-bold flex justify-center items-center'>E</div>
        </div>
      </div>
    </header>
  );
